...
stockStoreHouseRouter
    ...
    .get('/available/:storehouse_id', stockStoreHouseController.getAvailableStock)
    ...
    .patch('/input/in_section/:id', userValidations.authTypeUserValidation(['SUPER-ADMIN','ADMIN', "WAREHOUSE-MANAGER", "WAREHOUSEMAN"]),ActivityLogger, stockStoreHouseController.inputInSection)
