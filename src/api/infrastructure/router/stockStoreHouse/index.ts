...
stockStoreHouseRouter
    ...
    .patch('/input/in_location/:id', userValidations.authTypeUserValidation(['SUPER-ADMIN','ADMIN', "WAREHOUSE-MANAGER", "WAREHOUSEMAN"]),ActivityLogger, stockStoreHouseController.inputInLocation)
