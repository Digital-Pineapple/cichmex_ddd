...
.get('/section/:id',userValidations.authTypeUserValidation(['SUPER-ADMIN', "WAREHOUSEMAN", "WAREHOUSE-MANAGER"]), warehouseController.getSection)
...
.post('/section/add_product',userValidations.authTypeUserValidation(['SUPER-ADMIN', "WAREHOUSEMAN", "WAREHOUSE-MANAGER"]),ActivityLogger, warehouseController.addSingleProductToSection)
