...
export abstract class MongoRepository {
  ...
  public async findAllAll(id: string, populateOne?: any, populateTwo?: any,populateThree?:any, populateFour?: any): Promise<any> {
    return await this.MODEL.findById(id, { delted: false }).populate(populateOne).populate(populateTwo).populate(populateThree).populate(populateFour);
  }
  ...
  public async findById(_id: String, populateConfig?: any, populateConfig2?:any, populateConfig3?:any, populateConfig4?:any): Promise<any> {
    return await this.MODEL.findById( {_id,  status: true }).populate(populateConfig).populate(populateConfig2).populate(populateConfig3).populate(populateConfig4);
  }
  ...
  public async updateOne(_id: any, updated: object): Promise<any> {
