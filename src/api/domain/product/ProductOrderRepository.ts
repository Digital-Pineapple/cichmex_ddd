...
export interface ProductOrderRepository extends MongoRepository {
     ...
     findAllProductOrders(populateConfig1?:any, populateConfig2?:any,  populateConfig3?: any, populateConfig4?: any): Promise<ProductOrderEntity[] | ErrorHandler | null> 
     ...
     getPaidAndVerifyPackageToPointPO(user_id: any): Promise<ProductOrderEntity[] | ErrorHandler | null> 
